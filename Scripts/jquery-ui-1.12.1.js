		...
		$.each( draggable.sortables, function() {
			...
			if ( innermostIntersecting ) {
				...
				if ( !sortable.isOver ) {
					...
					// _Hack so receive/update callbacks work (mostly)
...
$.widget( "ui.dialog", {
	...
	_allowInteraction: function( event ) {
        ...
        // Para corrigir o search do select2
        // Remove hack when datepicker implements
		// the .ui-front logic (#8989)
		//return !!$( event.target ).closest( ".ui-datepicker" ).length;
        //return !!$(e.target).closest('.ui-dialog, .ui-datepicker, .select2-drop, .datepicker .bootstrap-filestyle', 'modal-backdrop','bootstrap-dialog').length;
        return true;
	},
